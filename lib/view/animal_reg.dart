...
class AnimalRegistration extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _AnimalRegistration();
}

class _AnimalRegistration extends State<AnimalRegistration> {

  String token =
      'eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImVtYWlsIiwiaWF0IjoiMTYzODM1ODU5OSIsImV4cCI6IjE2MzgzNjIxOTkiLCJqdGkiOiIxYzlkNjExOTY1YTFiOGFkMmE3MGZmZWU0ZTMyNmE0MyJ9.8bd55a6b3b954fc4d1e55dec900b6623e29f22daa87d262ee63fe5a43a2622763789970b2fbe6508653d6303e8354b3b46d482fca318426f7001b712671e790c';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Регистрация животных",
              ...
              var regionList = data.data;
              {
                return ListView.builder(
                    ...
                    itemBuilder: (context, int index) {
                      return ListTile(
                        leading: Text(
                          _items[index].locality_name,
                          style: const TextStyle(
                              fontSize: 16.0, color: AppColors.GREY_COLOR),
                        ),
                        trailing: Wrap(
                          ...
                          children: <Widget>[
                            Badge(
                              ...
                              badgeContent: Text(
                                  _items[index].data.length.toString(),
                                  style: const TextStyle(
                                      color: AppColors.GREY_COLOR)),
                            ), // icon-1
                            IconButton(
                              icon: Icon(selectedPrev
                                  ? Icons.navigate_next
                                  : Icons.title),
                              onPressed: () {
                                Navigator.of(context).pushNamed(
                                    ChooseOwner.routeName,
                                    arguments: jsonEncode(_items[index].data));
                              },
                            ),
                          ],
                        ),
